...
url = 'https://smokace.com/en/login'
user_email = "kiracase34@gmail.com"
user_password = "Q!!X3Nd!_y6zVX"
...
async def login(driver):
    ...
    await driver.get('https://smokace.com/en/account/personal-info', timeout=60)

    try:
        depos_but = await driver.find_element(By.XPATH, '//*[@id="__layout"]/div/main/div[2]/div/div[2]/div[1]/button', timeout=30)
        await asyncio.sleep(1.5)
        await driver.execute_script("arguments[0].click();", depos_but)

        choose_bit = await driver.find_element(By.XPATH, '//*[@id="walletDepositPaymentList"]/div[3]/div/div[13]', timeout=20)
        await asyncio.sleep(1)
