...
url = 'https://www.24bettle.com/en/login'
user_email = "kiracase34@gmail.com"
user_password = "vM9LhrwTXH2XwQf!"
...
async def login(driver):
    ...
    try:
        await click(driver, 30, '//*[@id="umbrellaModal"]/div/div/div[1]/a')
    ...
    try:
        ...
        await click(driver, 60, '//*[@id="deposits"]/div[4]/div/span[1]')
