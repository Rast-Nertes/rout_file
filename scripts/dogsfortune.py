...
url = 'https://dogsfortune.com/en-GB/login'
user_email = "kiracase34"
user_password = "UsJEURFrUQX63V5"
...
async def login(driver):
    ...
    await driver.get('https://dogsfortune.com/en-GB/home/account/manage-balance/deposit')
...
async def get_wallet():
    async with webdriver.Chrome(options=options) as driver:
        ...
        try:
            await asyncio.sleep(3.5)
            await click(driver, 30, '/html/body/app-root/app-main/div[1]/div/app-account/div/div/div/app-manage-balance/div/div[2]/app-manage-balance-deposit/app-manage-balance-transact/div/div/div/div[1]/div[5]/div')
            await asyncio.sleep(1.5)
            await click(driver, 30, '/html/body/app-root/app-main/div[1]/div/app-account/div/div/div/app-manage-balance/div/div[2]/app-manage-balance-deposit/app-manage-balance-transact/div/div/div/div[2]/div/div/form/app-action-button/button')
        except Exception as e:
