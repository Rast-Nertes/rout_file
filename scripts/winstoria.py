...
url = 'https://winstoria.com/ru/login'
user_email = "kiracase34@gmail.com"
user_password = "jQnxm#KJd2kuZ5"
...
async def login(driver):
    ...
    try:
        await input_data(driver, 40, '//*[@id="login"]', user_email)
        await input_data(driver, 30, '//*[@id="password"]', user_password)
        await click(driver, 20, '//*[@id="popupSubmit"]')
    except Exception as e:
        print(f"ERROR LOGIN \n{e}")

    await asyncio.sleep(4.5)
    await driver.get('https://winstoria.com/ru/wallet/deposit')
...
async def get_wallet():
    async with webdriver.Chrome(options=options) as driver:
        ...
        await asyncio.sleep(1.5)
        try:
            copy_address = await driver.find_element(By.XPATH,
                                                     '//*[@id="app"]/div/div/div[2]/div/div/ul/li[2]/div/div[3]/a',
                                                     timeout=20)
            await asyncio.sleep(1)
            ...
            copy_amount = await driver.find_element(By.XPATH,
                                                    '//*[@id="app"]/div/div/div[2]/div/div/ul/li[1]/div/div[3]/a',
                                                    timeout=20)
            await asyncio.sleep(2.5)
