...
async def login(driver):
    ...
    try:
        await click(driver, 30, '/html/body/div[1]/div/div[4]/div/div[3]/div[2]/button[1]')
    ...
    await driver.get('https://r7.casino/en/profile/cash', timeout=90)
