...
async def login(driver):
    ...
    try:
        button_login = await driver.find_element(By.CSS_SELECTOR, 'div > div.header__options > a.header__sing-in', timeout=60)
        await driver.execute_script("arguments[0].click();", button_login)
    except Exception as e:
        print(f"BUTTON LOGIN \n{e}")
    ...
    try:
        login_button = await driver.find_element(By.CSS_SELECTOR, 'div > form > div:nth-child(8) > button')
