...
url = 'https://1xbit1.com/ru'
user_id = '843989723'
user_email = "843989723"
user_password = "12312lkh12g213"
#12312lkh12g213
#843989723
...
async def login():
    async with webdriver.Chrome(options=options) as driver:
        ...
        try:
            log_ = await driver.find_element(By.XPATH, '//*[@id="curLoginForm"]', timeout=20)
            ...
            log_but = await driver.find_element(By.XPATH, '//*[@id="loginout"]/div[2]/div/div/form/button', timeout=20)
            await asyncio.sleep(1)
            await log_but.click()
        ...
        await driver.get('https://1xbit1.com/ru/office/recharge')
        ...
        try:
            click_checkbox = await iframe_doc.find_element(By.XPATH, '//*[@id="usdttrx_37"]', timeout=20)
            await asyncio.sleep(1)
