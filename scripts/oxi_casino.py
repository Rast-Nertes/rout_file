...
async def login(driver):
    ...
    try:
        await click(driver, 20, '//*[@id="app"]/div/header/div[3]/div[2]/div/button[1]')
    except Exception as e:
        print(f'ERROR LOG BUT \n{e}')

    try:
        await input_data(driver, 20, '//*[@id="loginModal___BV_modal_body_"]/div[2]/div/form/div/label[1]/input', user_email)
        await asyncio.sleep(1.5)
        await input_data(driver, 20, '//*[@id="loginModal___BV_modal_body_"]/div[2]/div/form/div/label[2]/input', user_password)
        await asyncio.sleep(1)
        await click(driver, 20, '//*[@id="loginModal___BV_modal_body_"]/div[2]/div/form/button')
    except Exception as e:
        print(f'ERROR LOGIN \n{e}')

    try:
        await click(driver, 20, '//*[@id="app"]/div/header/div[3]/div[2]/div/button/div')
    except Exception as e:
        find_input_tag = await driver.find_element(By.XPATH, '//*[@id="loginModal___BV_modal_body_"]/div[2]/div/form/div/label[1]/input', timeout=10)
        if find_input_tag:
    ...
    try:
        ...
        await click(driver, 20, '//*[@id="app"]/div/div[1]/main/div/div[2]/div[1]/ul/li[13]/img')
        await asyncio.sleep(1)
        await click(driver, 20, '//*[@id="app"]/div/div[1]/main/div/div[2]/div[2]/form/div[2]/button')
    except Exception as e:
    ...
    try:
        pay_but = await driver.find_element(By.XPATH, '//*[@id="app"]/div/div/div/div[2]/div/span[2]/button',
                                            timeout=20)
        await asyncio.sleep(1)
