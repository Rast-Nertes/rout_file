...
url = 'https://burningbet.com/en/wallet/deposit'
user_email = "rwork875@gmail.com"
user_password = "kk1238r123E1q"
...
async def login(driver):
    ...
    try:
        await click(driver, 20, '//*[@id="walletDepositPaymentList"]/div/div[2]/ul/li[4]/button/img')
    ...
    try:
        await click(driver, 20, '//*[@id="walletDepositSubmit"]')
    except Exception as e:
        print(f'ERROR DEPOS BUT \n{e}')
